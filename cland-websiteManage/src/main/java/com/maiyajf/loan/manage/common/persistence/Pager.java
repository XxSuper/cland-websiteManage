...
/**
 * 项目名称： myLoan-manage 类名称： Pager 描述： 用于分页的工具类
 * 
 * @author zhuzheng 创建时间： 2015年11月17日 下午7:31:15 修改人：zhuzheng 修改日期： 2015年11月17日 修改备注：
 *
 */
public class Pager<T> {
  ...
  private int limit = Integer.parseInt(Global.getConfig("page.pageSize")); // 每页显示记录数
  ...
  public String toString() {
    ...
    sb.append("[").append("total=").append(total).append(",pages=").append(pages)
        .append(",pageNumber=").append(pageNumber).append(",limit=").append(limit)
        .append(",isFirstPage=").append(isFirstPage).append(",isLastPage=").append(isLastPage)
        .append(",hasPreviousPage=").append(hasPreviousPage).append(",hasNextPage=")
        .append(hasNextPage).append(",navigatePageNumbers=");
