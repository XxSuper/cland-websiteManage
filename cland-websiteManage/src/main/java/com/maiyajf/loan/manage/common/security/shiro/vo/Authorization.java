package com.maiyajf.loan.manage.common.security.shiro.vo;
 ...
 * @since version1.0
 */
public class Authorization extends SimpleAuthenticationInfo implements Serializable {
  ...
  // 扩展User类,扩展属性
  public Authorization(boolean falgSetTranPassword, String principal, String credentials,
      boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired,
      boolean accountNonLocked, String operatorID, String realName, String operatorNo,
      int loginType, String mobile, int bisauthenticate, String isex, Date dbirthdate, String sidno,
      String sprovince, String scity, String saddress, int loginWinType) {
