...
/**
 * @ClassName: ConcurrentLoginControlFilter
 * @Description: 并发登陆
 * @author: zhuangsheng.chen
 * @date: 2016年2月23日 上午10:24:57
 */
public class ConcurrentLoginControlFilter extends AccessControlFilter {
   ...
   * (non-Javadoc)
   * 
   * @see org.apache.shiro.web.filter.AccessControlFilter#isAccessAllowed(javax
   ...
   * (non-Javadoc)
   * 
   * @see org.apache.shiro.web.filter.AccessControlFilter#onAccessDenied(javax.
  ...
  protected boolean onAccessDenied(ServletRequest request, ServletResponse response)
    ...
    if (session.getAttribute("kickout") != null) {
      saveRequest(request);
      request.setAttribute("kickout", Constants.TRUE);
