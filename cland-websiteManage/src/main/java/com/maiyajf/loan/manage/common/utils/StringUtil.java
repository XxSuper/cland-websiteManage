...
/**
 * 项目名称： myLoan-manage 类名称： StringUtil 描述： 字符串帮助类
 * 
 * @author zhuzheng 创建时间： 2015年11月16日 下午3:24:25 修改人：zhuzheng 修改日期： 2015年11月16日 修改备注：
 *
 */
public class StringUtil {
  ...
  /**
   * 方法名： isMobileNO 描述： 判断是否正确的手机号
   * 
   * @author zhuzheng 创建时间：2015年11月16日 下午3:25:31
   * @param phoneNo
   * @return
   *
   */
  ...
  /**
   * 方法名： isMoney 描述： 判断是否正确数字金额字符串
   * 
   * @author zhuzheng 创建时间：2015年12月11日 下午3:13:45
   * @param moneyStr
   * @return
   *
   */
  ...
  /**
   * 隐藏电话号码 显示前三，后四位，如：186****6097 dealMobile
   * 
   * @param
   * @return
   * @throws @author zhuzheng
  ...
  /**
   * 方法名： formatScore 描述： 格式化分数
   * 
   * @author zhuzheng 创建时间：2015年12月17日 上午11:26:23
   * @param string
   * @return
   *
   */
  public static Double formatScore(String str) {
    ...
    if (str == null || !str.matches("^[0-9]+(\\.[0-9]+)?$")) return null;
