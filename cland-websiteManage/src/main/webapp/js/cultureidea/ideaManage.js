 ...
 * @param newsNo
 */
function showEditIdea(newsNo) {
	window.location.href = ctx + "/culture/showEditIdea.htm?newsNo=" + newsNo;
}
...
function showSaveIdea() {
	window.location.href = ctx + "/culture/showSaveIdea.htm";
}