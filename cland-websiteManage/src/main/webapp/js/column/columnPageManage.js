 ...
 * @param newsNo
 */
function showEditColumn(columnNo, sFatherNo) {
	window.location.href = ctx + "/column/showEditColumn.htm?columnNo=" + columnNo + "&sFatherNo=" + sFatherNo;
}

function doDeleteAll() {
	var str = "";
	$("input[name='columnInfo']").each(function() {
...
function showSaveColumn() {
	window.location.href = ctx + "/column/showSaveColumn.htm";
}