...
<script type="text/javascript" src="${ctx}/js/cultureidea/addIdea.js?"></script>
		<!--页面标题-->
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="javascript:void(0)">
					<c:choose>
						<c:when test="${operate == 'add'}">文化理念新增管理</c:when>
						<c:when test="${operate == 'edit'}">文化理念编辑管理</c:when>
					</c:choose>
				</a>
			</li>
		...
		<form:form id="news" class="form-horizontal" name="news" action="${ctx}/culture/saveIdeaInfo.htm"
