...
<script type="text/javascript" src="${ctx}/js/knowCland/course.js?20171018"></script>
<!--页面标题-->
...
<ul class="breadcrumb">
    ...
    <li>
        <a href="javascript:void(0)">
            <c:choose>
                <c:when test="${operate == 'add'}">博荣历程新增管理</c:when>
                <c:when test="${operate == 'edit'}">博荣历程编辑管理</c:when>
            </c:choose>
        </a>
    </li>
...
<form:form id="news" class="form-horizontal" name="news" action="${ctx}/knowCland/saveCourse.htm"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <button type="button" class="btn blue" id="aaa" onclick="doSummitCourse()"><i class="  icon-ok icon-white"> </i>保存</button>
