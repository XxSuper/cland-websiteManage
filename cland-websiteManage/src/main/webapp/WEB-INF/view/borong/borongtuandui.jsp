        ...
        <div class="m-h4">
            <div class="wp">
                ...
                <ul class="ul-imgtxtq3">
                    <li>
                        <a href="">
                            <div class="pic"><img src="${ctx}/borong/images/picq8.jpg" alt=""></div>
                            <h3>刘德华<em>战略顾问</em></h3>
                            <div class="txt">
                                <h3>刘德华<em>战略顾问</em></h3>
                                <p>这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍</p>
                                <span>了解更多&gt;&gt;</span>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <div class="pic"><img src="${ctx}/borong/images/picq9.jpg" alt=""></div>
                            <h3>刘德华<em>战略顾问</em></h3>
                            <div class="txt">
                                <h3>刘德华<em>战略顾问</em></h3>
                                <p>这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍</p>
                    ...
                    <li>
                        <a href="">
                            <div class="pic"><img src="${ctx}/borong/images/picq10.jpg" alt=""></div>
                            <h3>刘德华<em>战略顾问</em></h3>
                            <div class="txt">
                                <h3>刘德华<em>战略顾问</em></h3>
                                <p>这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍</p>
                    ...
                    <li>
                        <a href="">
                            <div class="pic"><img src="${ctx}/borong/images/picq11.jpg" alt=""></div>
                            <h3>刘德华<em>战略顾问</em></h3>
                            <div class="txt">
                                <h3>刘德华<em>战略顾问</em></h3>
                                <p>这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍这里是简单介绍</p>
