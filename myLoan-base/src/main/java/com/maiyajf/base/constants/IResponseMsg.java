...
public interface IResponseMsg {
	...
	String REGIST_MAIYA_IN_EXIST_FRBAO = "该手机号已注册过付融宝借款端，您可直接登录付融宝借款端";
	String REGIST_FRBAO_IN_MAIYA_EXIST = "该手机号已注册过麦芽贷，您可直接登录麦芽贷";
	String ALREADY_REGIST_IN_MAIYAFQ = "该手机号已注册过麦芽贷分期版，您可直接登录麦芽贷分期版";
