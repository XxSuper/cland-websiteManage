...
import com.maiyajf.base.monitor.task.manager.dao.TaskManagerDAO;
...
public class TaskManagerService {
	...
	public boolean lockTask(String sTaskNumber) {
		...
		TaskManagerDAO taskMgrDAO = SpringContextHolder.getBean(TaskManagerDAO.class);
		TaskManagerPO tm = taskMgrDAO.queryTaskLock(sTaskNumber);
		if (tm == null) {
			ExceptionLogger.error(sTaskNumber, "该任务编号没有对应的任务！");
			return false;
		}
		boolean unlocked = true; // 任务未锁定
